...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post credit_cards_url, params: { credit_card: { card_number: @credit_card.card_number, cvc: @credit_card.cvc, expiration_mm: @credit_card.expiration_mm, expiration_yy: @credit_card.expiration_yy, name: @credit_card.name } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { card_number: @credit_card.card_number, cvc: @credit_card.cvc, expiration_mm: @credit_card.expiration_mm, expiration_yy: @credit_card.expiration_yy, name: @credit_card.name } }
